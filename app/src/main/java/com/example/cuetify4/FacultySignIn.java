...
public class FacultySignIn extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInEmailEditText= findViewById(R.id.facultySignInEmail);
        signInPasswordEditText=findViewById(R.id.facultySignInPassword);
        signInButton =findViewById(R.id.facultySignInButton);
    ...
    private void facultyLogIn() {
        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    Intent intent=new Intent(getApplicationContext(),FacultyPanel.class);
